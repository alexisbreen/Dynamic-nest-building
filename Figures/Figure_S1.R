...
#Script for plotting Figure S1 for the manuscript
...
#Extract samples
#Note this overwrites EWA_b and EWA_m samples, if corresponding models already run/extracted; or anything related to Figure S3 script
...
pdf(file = "Figure_S1.pdf", height = 7, width = 10)  #If want pdf of plot
...
mtext("Individual cognition checks", side = 3, line = 0.5, outer = TRUE, font = 2, cex = 1)
